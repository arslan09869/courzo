    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-black">
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardTitle>Log in to Courzo</CardTitle>
          <CardDescription>
            Continue learning with your courses and progress
          </CardDescription>
        </CardHeader>
        ...
        <CardContent className="space-y-5 mb-4">
          <SignIn.Root>
            <SignIn.Step name="start" className="space-y-5">
              <Clerk.GlobalError className="block text-sm text-red-500 text-center" />

              {/* Google */}
              <Clerk.Connection name="google" asChild>
                <Button variant="outline" className="w-full border-dashed border-black gap-2">
